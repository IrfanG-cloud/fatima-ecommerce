    ...
    <div className='w-full bg-[#000]'>
      <div className='justify-between px-6 py-10 md:flex lg:flex'>
        <div className='text-[#4f4f4f] pointer py-4 text-center md:text-start'> 
          <div className='' >
          <h3 className='text-2xl font-bold mb-2 '>Fatima Alhaj</h3>
        ...
        <div className='text-[#4f4f4f] py-4 text-center md:text-start'>
          ...
          <ul className=''>
            ...
            <Link href={"https://api.whatsapp.com/send?phone=963995817380"} className=' text-[#4f4f4f] hover:text-[#fff] mb-2'><li>24h Service</li></Link>
            <Link href={"https://api.whatsapp.com/send?phone=963995817380"} className=' text-[#4f4f4f] hover:text-[#fff] mb-2'><li>Quick Chat</li></Link>
        ...
        <div className='text-[#4f4f4f] py-4 text-center md:text-start'>
          ...
          <ul className=''>
            <Link href={"https://api.whatsapp.com/send?phone=963995817380"} className=' text-[#4f4f4f] hover:text-[#fff] mb-2'><li>Whatsapp </li></Link>
            <Link href={"https://api.whatsapp.com/send?phone=963995817380"} className=' text-[#4f4f4f] hover:text-[#fff] mb-2'><li>Support 24h</li></Link>
